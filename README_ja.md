...
**「Streamlit サンプルアプリ」** というタイトルのページが表示されます。ページには以下が含まれます：

* 「アプリは正常に動作しています。」という緑色の成功バナー
* 「ようこそ！」から始まるアプリの説明
* カスタマイズの手順を示す「次のステップ」セクション
* 起動コマンドを表示する「起動方法」の折りたたみセクション

デフォルトは英語です。サイドバーから英語と日本語を切り替えることができます。
